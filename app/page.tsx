...
import { MobileNativeFeatures } from "@/components/mobile-native-features"
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <MobileNavigation onNavigate={handleNavigate} currentSection={currentSection} />
